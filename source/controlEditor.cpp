...
void controlEditor::battleFile(std::string file) {
	...
	// Recompress file
	if (trimfile == "2593.unk8") {
		int batch_decompress = system("..\\..\\Tools\\xenopack.exe -p 2593.unk8");
	}
	if (trimfile == "3958.unk8") {
		int batch_decompress = system("..\\..\\Tools\\xenopack.exe -p 3958.unk8");
	}
